  ...
  const faqItems: FaqItem[] = [
    {
      ...
      answer: 'Z世代〜30代の社会人を対象としたキャリアコーチングと、企業向けの若手定着支援プログラムを提供しています。<br />1on1の対話を通して、強み・価値観・キャリアの方向性を言語化し、「個人カルテ」として可視化することで、ご本人の納得感と、組織としての育成を両立します。',
    },
    {
      question: 'どのような課題をお持ちの方・企業に向いていますか？',
      answer: '「このまま今の会社にいていいのか不安」「頑張っているのに評価されていない気がする」と感じている20〜30代の方に多くご利用いただいています。<br />企業様では、若手社員の早期離職やモチベーション低下、管理職の育成負担の増大にお悩みの人事・経営者の方に導入いただいています。',
    },
    {
      question: 'お問い合わせから実施までどのくらいかかりますか？',
      answer: '個人セッションは、日程が合えば 1〜2週間以内 の実施が可能です。<br />法人プログラムは、ヒアリング〜ご提案まで通常 1〜2週間程度 を目安にしています。',
    },
    {
      question: '実施方法・エリアを教えてください。',
      answer: 'すべてオンライン（Zoom等）で実施しているため、全国どこからでもご利用いただけます。<br />法人様向けには、オンラインに加えて、状況に応じて訪問でのご相談も承っています。',
    },
  ];
