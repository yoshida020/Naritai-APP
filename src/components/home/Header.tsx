...
export default function Header() {
  ...
  return (
    <>
      <div className="fixed top-0 right-0 w-[60px] h-[60px] md:w-[160px] md:h-[90px] lg:w-[175px] lg:h-[100px] bg-gray-400 z-[1001] rounded-bl-3xl flex flex-col items-center justify-center overflow-hidden hover:bg-[#202D5F] transition-colors duration-300 cursor-pointer">
        ...
        >
          <div className="relative w-6 h-6 flex items-center justify-center">
            <span className={`w-6 h-0.5 bg-white transition-all duration-300 rounded-sm absolute ${
              isMobileMenuOpen 
                ? 'rotate-45 top-1/2 -translate-y-1/2' 
                : 'rotate-0 top-0'
            }`}></span>
            <span className={`w-6 h-0.5 bg-white transition-all duration-300 rounded-sm absolute top-1/2 -translate-y-1/2 ${
              isMobileMenuOpen 
                ? 'opacity-0' 
                : 'opacity-100'
            }`}></span>
        ...
        <nav className="hidden md:block pr-[180px] lg:pr-[195px]">
          <ul className="flex list-none gap-0 m-0 p-0 items-center flex-wrap justify-end">
            <li className="flex items-center">
              <a 
                href="#top" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#top' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#top')}
              >
                トップ
                <span className={`absolute bottom-0 left-1/2 h-[1px] bg-gradient-to-r from-[#362ae0] via-[#3b79cc] to-[#42d3ed] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] transform -translate-x-1/2 ${
                  activeSection === '#top' ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </a>
            ...
            <li className="flex items-center">
              <a 
                href="#about" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#about' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
            ...
            <li className="flex items-center">
              <a 
                href="#message" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#message' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#message')}
              >
                メッセージ
                <span className={`absolute bottom-0 left-1/2 h-[1px] bg-gradient-to-r from-[#362ae0] via-[#3b79cc] to-[#42d3ed] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] transform -translate-x-1/2 ${
                  activeSection === '#message' ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </a>
              <span className="text-[17px] text-[#2C3E50] mx-2">/</span>
            </li>
            <li className="flex items-center">
              <a 
                href="#business" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#business' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#business')}
              >
                事業内容
                <span className={`absolute bottom-0 left-1/2 h-[1px] bg-gradient-to-r from-[#362ae0] via-[#3b79cc] to-[#42d3ed] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] transform -translate-x-1/2 ${
                  activeSection === '#business' ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </a>
              <span className="text-[17px] text-[#2C3E50] mx-2">/</span>
            </li>
            <li className="flex items-center">
              <a 
                href="#news" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#news' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#news')}
              >
                News
                <span className={`absolute bottom-0 left-1/2 h-[1px] bg-gradient-to-r from-[#362ae0] via-[#3b79cc] to-[#42d3ed] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] transform -translate-x-1/2 ${
                  activeSection === '#news' ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </a>
              <span className="text-[17px] text-[#2C3E50] mx-2">/</span>
            </li>
            <li className="flex items-center">
              <a 
                href="#faq" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#faq' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
            ...
            <li className="flex items-center">
              <a 
                href="#company" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#company' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#company')}
              >
                会社概要
                <span className={`absolute bottom-0 left-1/2 h-[1px] bg-gradient-to-r from-[#362ae0] via-[#3b79cc] to-[#42d3ed] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] transform -translate-x-1/2 ${
                  activeSection === '#company' ? 'w-full' : 'w-0 group-hover:w-full'
                }`}></span>
              </a>
              <span className="text-[17px] text-[#2C3E50] mx-2">/</span>
            </li>
            <li>
              <a 
                href="#contact" 
                className={`text-[17px] font-medium no-underline transition-colors duration-300 relative py-2 whitespace-nowrap block group hover:text-[#5AB1E0] ${
                  activeSection === '#contact' ? 'text-[#5AB1E0]' : 'text-[#2C3E50]'
                }`}
                onClick={(e) => handleLinkClick(e, '#contact')}
              >
                お問い合わせ
      ...
      <div 
        className={`fixed top-0 left-0 w-full h-screen bg-white z-[999] flex items-center justify-center md:hidden transition-transform duration-300 ease-in-out ${
          isMobileMenuOpen 
            ? 'translate-x-0' 
