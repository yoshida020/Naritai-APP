...
export default function HeroSection() {
  return (
    <div
      id="top"
      className="relative w-full min-h-screen m-0 pt-20 box-border bg-[url('/images/hero/hero-bg.png')] bg-[length:auto_100%] bg-[position:77%_top] bg-no-repeat md:bg-cover md:bg-[position:77%_center] flex items-end md:items-center justify-center md:justify-start text-[#2C3E50] overflow-hidden scroll-mt-20 md:pt-20 pb-4 md:pb-0"
    >
