...
export default function CorporateSection() {
  ...
  return (
    <section
      id="corporate"
      className="relative w-full pt-24 pb-16 md:pb-36 px-4 text-slate-800"
    >
      <div className="max-w-[1200px] w-full mx-auto relative" ref={containerRef}>
        ...
        >
          {effects.map((effect, index) => {
            ...
            let pcTranslate = '';
            if (index === 0) pcTranslate = 'lg:translate-y-24';
            if (index === 1) pcTranslate = 'lg:-translate-y-8';
            if (index === 2) pcTranslate = 'lg:translate-y-16';
            if (index === 3) pcTranslate = 'lg:-translate-y-16';
            if (index === 4) pcTranslate = 'lg:translate-y-4';
